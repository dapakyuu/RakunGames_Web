...
if (isset($_POST['submit'])) {
    ...
    // Cek username/email duplikat di tabel user (kecuali data sendiri)
    $sql = "SELECT * FROM user WHERE (username=? OR email=?) AND id_user != ?";
    $stmt = $koneksi->prepare($sql);
    ...
    if ($password) {
        $query = "UPDATE user SET username = ?, email = ?, phone = ?, pass = ? WHERE id_user = ?";
        $stmt = $koneksi->prepare($query);
        $stmt->bind_param("ssssi", $username, $email, $phone, $password, $id);
    } else {
        $query = "UPDATE user SET username = ?, email = ?, phone = ? WHERE id_user = ?";
        $stmt = $koneksi->prepare($query);
...
<head>
    ...
    <title>AdminRakunGames | Tabel User</title>
                                                ...
                                                echo "
                                                    <tr class='text-center'>
                                                        ...
                                                        <td class='project-actions text-center'>
                                                            ...
                                                            <form method='POST' action='tabel_user.php' style='display:inline;'>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="editForm" action="tabel_user.php" method="POST">
