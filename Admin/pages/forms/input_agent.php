...
if (isset($_POST['submit'])) {
    ...
    // Insert agent baru
    $sql = "INSERT INTO agent (username, nama, email, game, pass, phone) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $koneksi->prepare($sql);
    $stmt->bind_param("ssssss", $username, $nama, $email, $game, $password, $phone);

    if ($stmt->execute()) {
        $_SESSION['input_success'] = "Agent berhasil ditambahkan!";
    } else {
        $_SESSION['input_error'] = "Gagal menambahkan agent!";
    }
    $stmt->close();
    header("Location: " . $_SERVER['PHP_SELF']);
    exit();
...
<head>
    ...
    <title>AdminRakunGames | Input Agent</title>
                        ...
                        <?php if ($_SESSION["is_admin"]): ?>
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="input_agent.php" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Agent</p>
                                        </a>
                                    </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Input Agent</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../../dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Input Agent</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <!-- Main content -->
            <?php include 'content_input_agent.php'; ?>
            <!-- /.content -->
        </div>
        <!-- /.content-wrapper -->
