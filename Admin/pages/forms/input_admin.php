...
if (isset($_POST['submit'])) {
    ...
    // Insert admin baru jika username dan email belum digunakan
    $sql = "INSERT INTO admin (username, email, pass, phone) VALUES (?, ?, ?, ?)";
    $stmt = $koneksi->prepare($sql);
    $stmt->bind_param("ssss", $username, $email, $password, $phone);

    if ($stmt->execute()) {
        $_SESSION['input_success'] = "Admin berhasil ditambahkan!";
    } else {
        $_SESSION['input_error'] = "Gagal menambahkan admin!";
    }
    $stmt->close();
    header("Location: " . $_SERVER['PHP_SELF']);
    exit();
...
<head>
    ...
    <title>AdminRakunGames | Input Admin</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                        ...
                        <?php if ($_SESSION["is_admin"]): ?>
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="input_admin.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <?php include 'content_input_admin.php'; // Memisahkan konten form ke file terpisah 
            ?>
            <!-- /.content -->
        </div>
        <!-- /.content-wrapper -->
