    ...
    <section class="store-section">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                <h2 class="display-4 fw-bold">Pilih Game Online</h2>
            </div>
            <div class="row g-4">
                <?php
                $games = [
                ...
                ?>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo $delay; ?>">
                        <a href="paket.php?game=<?php echo $gameSlug; ?>" class="text-decoration-none">
                            <div class="card game-card">
                                <img src="../assets/<?php echo $gameSlug; ?>.png"
